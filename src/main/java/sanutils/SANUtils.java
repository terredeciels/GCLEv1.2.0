...
public class SANUtils {
    ...
    public static GCoups toMove(final GPosition gPosition, final String pSAN) throws SANException {
        if (gPosition == null) {
        ...
        if ("0-0".equals(pSAN)) {
            ...
            if (trait) {
                return new GCoups(ROI, e1, g1, h1, f1, 0, ICodage.TYPE_DE_COUPS.Roque);
...
//        System.out.println("mvts83= " + mvts);
     ...
     * @return
     */
    public static String toSAN(GPosition gPosition, final GCoups pMouvement) {
        if (gPosition == null) {
            throw new NullPointerException("Missing game state");
        }
        if (pMouvement == null) {
